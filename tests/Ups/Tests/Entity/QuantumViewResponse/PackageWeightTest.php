...
class  PackageWeightTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $packageWeight = new \Ups\Entity\QuantumViewResponse\PackageWeight();
        ...
        $this->assertTrue($doc->schemaValidate(__DIR__ . '/../../_files/entities/QuantumViewResponse/PackageWeight.xsd'));
    }
}

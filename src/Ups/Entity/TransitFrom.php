...
class TransitFrom implements NodeInterface
{
    /**
     * @var string
     */
    ...
    public function toNode(DOMDocument $document = null)
    {
        ...
        $node = $document->createElement('TransitFrom');
        ...
        $node->appendChild($document->createElement('StreetType', $this->getStreetType()));

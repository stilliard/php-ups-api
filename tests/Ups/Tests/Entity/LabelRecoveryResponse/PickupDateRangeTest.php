...
class  PickupDateRangeTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $pickupDateRange = new \Ups\Entity\LabelRecoveryResponse\PickupDateRange();
        ...
        $this->assertTrue($doc->schemaValidate(__DIR__ . '/../../_files/entities/LabelRecoveryResponse/PickupDateRange.xsd'));
    }
}

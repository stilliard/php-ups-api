...
class  DeliveryLocationAddressArtifactFormat implements NodeInterface
{
    /**
     * @var string
     */
    ...
    public function toNode(DOMDocument $document = null)
    {
        ...
        $node = $document->createElement('DeliveryLocationAddressArtifactFormat');
        ...
        if (null !== $this->getBuildingName()) {
            $node->appendChild($document->createElement('BuildingName', $this->getBuildingName()));
        }
        ...
        if (null !== $this->getPostcodeExtendedLow()) {
